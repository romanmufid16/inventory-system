...
@section('content')
    ...
    <div id="toastSuccess" class="fixed top-5 right-5 hidden bg-white border-t-4 border-green-500 text-green-500 p-4 rounded-lg shadow-lg">
        <h1 class="text-lg font-semibold text-black">Success</h1>
        {{ session('success') }}
    </div>
    <div id="toastError" class="fixed top-5 right-5 hidden bg-white border-t-4 border-red-500 text-red-500 p-4 rounded-lg shadow-lg">
        <h1 class="text-lg font-semibold text-black">Error</h1>
        {{ session('error') }}
    </div>
    @if (session('success'))
        <script>
