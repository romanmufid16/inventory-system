...
@section('content')
    <div class="px-6 pb-20 pt-6">
        ...
        <div class="grid grid-cols-1">
            <div class="card" id="listjs" data-list="name,contact_person,phone_number,address,action_info">
                <div
                    ...
                    <table class="text-left w-full whitespace-nowrap">
                        <thead class="bg-sky-800 text-white">
                            <tr class="border-b border-gray-300">
                                <th class="pl-3 py-3" data-sort="supplier_checks">
                                ...
                                <tr class="border-b border-gray-300 hover:bg-gray-100">
                                    <td class="pl-3 py-3">
                                        <div class="flex items-center mb-1">
                                            <input
                                                class="w-4 h-4 text-indigo-600 bg-white border-gray-300 rounded focus:ring-indigo-600 focus:outline-none focus:ring-2"
                                                type="checkbox" value="{{ $item->id }}" id="suppliersCheckbox2" />
                                            <label for="suppliersCheckbox2"></label>
                                        </div>
                                    </td>
